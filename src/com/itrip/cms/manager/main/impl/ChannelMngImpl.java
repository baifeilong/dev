...
import com.itrip.cms.dao.main.ChannelDao;
...
import com.itrip.cms.manager.main.ChannelTxtMng;
...
public class ChannelMngImpl implements ChannelMng {
	...
	public Channel save(Channel bean, ChannelExt ext, ChannelTxt txt, Integer[] viewGroupIds, Integer[] contriGroupIds, Integer[] userIds,
			Integer siteId, Integer parentId, Integer modelId, Integer[] modelIds, String[] tpls) {
		if (parentId != null) {
	...
	public Channel update(Channel bean, ChannelExt ext, ChannelTxt txt, Integer[] viewGroupIds, Integer[] contriGroupIds, Integer[] userIds,
			Integer parentId, Map<String, String> attr, Integer[] modelIds, String[] tpls) {
		// 更新主表
	...
	public String findByOldPath(String cpath) {
		...
		return dao.findByOldPath(cpath);
	}
