package com.itrip.cms.web;

import static com.itrip.cms.Constants.RES_PATH;
import static com.itrip.cms.Constants.TPLDIR_COMMON;
import static com.itrip.cms.Constants.TPLDIR_STYLE_LIST;
import static com.itrip.cms.Constants.TPLDIR_TAG;
import static com.itrip.cms.Constants.TPL_STYLE_PAGE_CHANNEL;
import static com.itrip.cms.Constants.TPL_SUFFIX;
import static com.itrip.common.web.Constants.MESSAGE;
import static com.itrip.common.web.Constants.UTF8;
import static com.itrip.common.web.ProcessTimeFilter.START_TIME;
import static com.itrip.common.web.freemarker.DirectiveUtils.PARAM_TPL_SUB;
import static com.itrip.core.action.front.LoginAct.PROCESS_URL;
...
public class FrontUtils {
	...
	public static String getTplPath(HttpServletRequest request, CmsSite site, String dir, String name) {
		String solution = RequestUtils.isMobile(request) ? site.getMobileSolutionPath() : site.getSolutionPath();
	 ...
	 * @throws TemplateException
	 */
	public static void includeTpl(String tplName, CmsSite site, Map<String, TemplateModel> params, Environment env) throws IOException,
			TemplateException {
	...
	/**
	 * @Title: getTplPath
	 * @Description: 获取栏目方案路径
	 * @param request
	 * @param channel
	 *            栏目对象
	 * @return String 方案路径
	 */
	public static String getTplPath(HttpServletRequest request, Channel channel) {
		String cTpl = channel.getTplChannelOrDef();
		return RequestUtils.isMobile(request) ? getMobileTplPath(cTpl) : cTpl;
	}
	 ...
	 * @return String 方案路径
	 */
	public static String getTplPath(HttpServletRequest request, Content content) {
		String cTpl = content.getTplContentOrDef();
		return RequestUtils.isMobile(request) ? getMobileTplPath(cTpl) : cTpl;
	}

	/**
	 * @Title: getMobileTplPath
	 * @Description: 获取移动端模板
	 * @param pcTpl
	 * @return String 模板路径
	 */
	public static String getMobileTplPath(String pcTpl) {
		return StringUtils.replaceOnce(pcTpl, Constants.TPL_DEFAULT, Constants.TPL_MOBILE);
	}
}
