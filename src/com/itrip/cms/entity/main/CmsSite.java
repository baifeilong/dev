package com.itrip.cms.entity.main;

import static com.itrip.cms.Constants.LIBRARY_PATH;
import static com.itrip.cms.Constants.RES_PATH;
import static com.itrip.cms.Constants.TPL_BASE;
import static com.itrip.cms.Constants.UPLOAD_PATH;
import static com.itrip.common.web.Constants.TPL_MOBILE;
import static com.itrip.common.web.Constants.TPL_DEFAULT;

import java.util.Collection;

import org.apache.commons.lang.StringUtils;

import com.itrip.cms.entity.main.base.BaseCmsSite;
...
public class CmsSite extends BaseCmsSite {
	...
	public String getUrlStatic() {
		...
		// 静态首页加上静态目录作为访问路径，白飞龙 2015-08-31
		String filename = getUrlBuffer(false, null, true).toString();
		String real = getStaticDir().startsWith("/") ? filename + getStaticDir() : filename + "/" + getStaticDir();
		return real;
	}
	...
	/**
	 * 获得模板方案路径。如：/WEB-INF/t/cms/www/red
	 * 
	 * @return
	 */
	...
	/**
	 * 获得移动端模板方案路径。如：/WEB-INF/t/cms/www/mobile
	 * 
	 * @return
	 */
	...
	public String getUploadPath() {
		...
		// 去掉path，直接使用upload_path 白飞龙 2015-08-28
		return UPLOAD_PATH;
	}
	...
	public void init() {
		...
		if (StringUtils.isBlank(getTplMobileSolution())) {
			setTplMobileSolution(TPL_MOBILE);
		}
		if (StringUtils.isBlank(getTplSolution())) {
			setTplSolution(TPL_DEFAULT);
		}
	 ...
	 */
	public CmsSite(java.lang.Integer id, com.itrip.cms.entity.main.CmsConfig config, java.lang.String domain, java.lang.String path,
			java.lang.String name, java.lang.String protocol, java.lang.String dynamicSuffix, java.lang.String staticSuffix,
			java.lang.Boolean indexToRoot, java.lang.Boolean staticIndex, java.lang.String localeAdmin, java.lang.String localeFront,
			java.lang.String tplSolution, java.lang.String tplSolutionMobile, java.lang.Byte finalStep, java.lang.Byte afterCheck,
			java.lang.Boolean relativePath, java.lang.Boolean resycleOn) {

		super(id, config, domain, path, name, protocol, dynamicSuffix, staticSuffix, indexToRoot, staticIndex, localeAdmin, localeFront, tplSolution,
				tplSolutionMobile, finalStep, afterCheck, relativePath, resycleOn);
	}
