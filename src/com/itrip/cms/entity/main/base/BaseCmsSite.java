...
public abstract class BaseCmsSite implements Serializable {
	...
	public static String PROP_TPL_MOBILE_SOLUTION = "tplMobileSolution";
	 ...
	 */
	public BaseCmsSite(java.lang.Integer id, com.itrip.cms.entity.main.CmsConfig config, java.lang.String domain, java.lang.String path,
	...
	private com.itrip.cms.entity.main.CmsSiteCompany siteCompany;

	// many to one
	private com.itrip.core.entity.Ftp uploadFtp;
	private com.itrip.cms.entity.main.CmsConfig config;
	...
	/**
	 * 
	 * @Title: setTplMobileSolution
	 * @Description: 移动端模板方案名称
	 * @param tplSolutionMobile
	 *            设定文件
	 * @return void 返回类型
	 */
	...
	public com.itrip.cms.entity.main.CmsSiteCompany getSiteCompany() {
		return siteCompany;
	}

	public void setSiteCompany(com.itrip.cms.entity.main.CmsSiteCompany siteCompany) {
	 ...
	 */
	public com.itrip.core.entity.Ftp getUploadFtp() {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp(com.itrip.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.itrip.cms.entity.main.CmsConfig getConfig() {
		return config;
	}
	 ...
	 *            the config_id value
	 */
	public void setConfig(com.itrip.cms.entity.main.CmsConfig config) {
		this.config = config;
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.itrip.cms.entity.main.CmsSite))
			return false;
		else {
			com.itrip.cms.entity.main.CmsSite cmsSite = (com.itrip.cms.entity.main.CmsSite) obj;
