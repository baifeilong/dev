...
public abstract class BaseChannel implements Serializable {
	 ...
	 */
	public BaseChannel(java.lang.Integer id, com.itrip.cms.entity.main.CmsSite site, com.itrip.cms.entity.main.CmsModel model, java.lang.Integer lft,
			java.lang.Integer rgt, java.lang.Integer priority, java.lang.Boolean hasContent, java.lang.Boolean display) {
	...
	// one to one
	private com.itrip.cms.entity.main.ChannelExt channelExt;

	// many to one
	private com.itrip.cms.entity.main.CmsSite site;
	private com.itrip.cms.entity.main.CmsModel model;
	private com.itrip.cms.entity.main.Channel parent;

	// collections
	private java.util.Set<com.itrip.cms.entity.main.Channel> child;
	private java.util.Set<com.itrip.cms.entity.main.CmsGroup> viewGroups;
	private java.util.Set<com.itrip.cms.entity.main.CmsGroup> contriGroups;
	private java.util.Set<com.itrip.cms.entity.main.CmsUser> users;
	private java.util.Set<com.itrip.cms.entity.main.ChannelTxt> channelTxtSet;
	private java.util.List<com.itrip.cms.entity.main.ChannelModel> channelModels;
	 ...
	 */
	public com.itrip.cms.entity.main.ChannelExt getChannelExt() {
		return channelExt;
	}
	 ...
	 */
	public void setChannelExt(com.itrip.cms.entity.main.ChannelExt channelExt) {
	 ...
	 */
	public com.itrip.cms.entity.main.Channel getParent() {
		return parent;
	}
	 ...
	 *            the parent_id value
	 */
	public void setParent(com.itrip.cms.entity.main.Channel parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.itrip.cms.entity.main.Channel> getChild() {
		return child;
	}
	 ...
	 *            the child value
	 */
	public void setChild(java.util.Set<com.itrip.cms.entity.main.Channel> child) {
		this.child = child;
	}
	 ...
	 */
	public java.util.Set<com.itrip.cms.entity.main.CmsGroup> getContriGroups() {
		return contriGroups;
	}
	 ...
	 */
	public void setContriGroups(java.util.Set<com.itrip.cms.entity.main.CmsGroup> contriGroups) {
	 ...
	 */
	public java.util.Set<com.itrip.cms.entity.main.CmsUser> getUsers() {
		return users;
	}
	 ...
	 *            the users value
	 */
	public void setUsers(java.util.Set<com.itrip.cms.entity.main.CmsUser> users) {
		this.users = users;
	}
	 ...
	 */
	public java.util.Set<com.itrip.cms.entity.main.ChannelTxt> getChannelTxtSet() {
	 ...
	 */
	public void setChannelTxtSet(java.util.Set<com.itrip.cms.entity.main.ChannelTxt> channelTxtSet) {
		this.channelTxtSet = channelTxtSet;
	}

	public java.util.List<com.itrip.cms.entity.main.ChannelModel> getChannelModels() {
		return channelModels;
	}

	public void setChannelModels(java.util.List<com.itrip.cms.entity.main.ChannelModel> channelModels) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.itrip.cms.entity.main.Channel))
			return false;
		else {
			com.itrip.cms.entity.main.Channel channel = (com.itrip.cms.entity.main.Channel) obj;
