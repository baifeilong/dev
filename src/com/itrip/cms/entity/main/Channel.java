...
import com.itrip.cms.entity.main.base.BaseChannel;
import com.itrip.cms.staticpage.StaticPageUtils;
import com.itrip.common.hibernate3.HibernateTree;
import com.itrip.common.hibernate3.PriorityComparator;
import com.itrip.common.hibernate3.PriorityInterface;
...
public class Channel extends BaseChannel implements HibernateTree<Integer>, PriorityInterface {
	...
	public String getChannelIds() {
		...
		Channel parent = getParent();
		if (parent != null) {
			Set<Channel> set = parent.getChild();
			for (Channel c : set) {
				ids += c.getId() + ",";
			}
	 ...
	 */
	public Channel(java.lang.Integer id, com.itrip.cms.entity.main.CmsSite site, com.itrip.cms.entity.main.CmsModel model, java.lang.Integer lft,
