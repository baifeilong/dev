	...
	public String index(Integer channelId, Integer topicId, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		if (topicId != null) {
			...
			if (StringUtils.isBlank(tpl)) {
				tpl = FrontUtils.getTplPath(request, site, TPLDIR_TOPIC, TOPIC_DEFAULT);
			}
			return tpl;
			...
			return FrontUtils.getTplPath(request, site, TPLDIR_TOPIC, TOPIC_CHANNEL);
		} else {
			return FrontUtils.getTplPath(request, site, TPLDIR_TOPIC, TOPIC_INDEX);
		}
	}
