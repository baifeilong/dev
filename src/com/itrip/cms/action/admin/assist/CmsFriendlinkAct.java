...
import com.itrip.cms.entity.assist.CmsFriendlink;
...
import com.itrip.cms.manager.assist.CmsFriendlinkCtgMng;
import com.itrip.cms.manager.assist.CmsFriendlinkMng;
...
public class CmsFriendlinkAct {
	...
	public String list(Integer queryCtgId, HttpServletRequest request, ModelMap model) {
		...
		List<CmsFriendlink> list = manager.getList(site.getId(), queryCtgId, null);
		List<CmsFriendlinkCtg> ctgList = cmsFriendlinkCtgMng.getList(site.getId());
	...
	public String save(CmsFriendlink bean, Integer ctgId, HttpServletRequest request, ModelMap model) {
		...
		cmsLogMng.operating(request, "cmsFriendlink.log.save", "id=" + bean.getId() + ";name=" + bean.getName());
	...
	public String update(CmsFriendlink bean, Integer ctgId, Integer queryCtgId, String oldLog, HttpServletRequest request, ModelMap model) {
		...
		cmsLogMng.operating(request, "cmsFriendlink.log.update", "id=" + bean.getId() + ";name=" + bean.getName());
	...
	public String delete(Integer[] ids, Integer queryCtgId, HttpServletRequest request, ModelMap model) {
		...
		for (CmsFriendlink bean : beans) {
			...
			cmsLogMng.operating(request, "cmsFriendlink.log.delete", "id=" + bean.getId() + ";name=" + bean.getName());
		}
		return list(queryCtgId, request, model);
	}
