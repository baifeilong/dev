...
import com.itrip.cms.manager.assist.CmsVoteItemMng;
...
public class CmsVoteTopicAct {
	...
	public String save(CmsVoteTopic bean, Integer[] subPriority, String[] itemTitle, Integer[] itemVoteCount, Integer[] itemPriority,
	...
	public String update(CmsVoteTopic bean, Integer[] subPriority, Integer[] subTopicId, String[] itemTitle, Integer[] itemVoteCount,
			Integer[] itemPriority, Integer pageNo, HttpServletRequest request, ModelMap model) {
