...
public class CmsFireWallConfigAct {
	...
	public String update(HttpServletRequest request, Model model, String open, String oldPassword, String password, String domain, String[] week,
			String[] hour, String ips) throws IOException {
		InputStream in = new FileInputStream(realPathResolver.get(Constants.FIREWALL_CONFIGPATH));
		Properties p = new Properties();
		p.load(in);
