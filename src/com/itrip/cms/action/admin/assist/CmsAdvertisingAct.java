...
import com.itrip.cms.manager.assist.CmsAdvertisingSpaceMng;
...
public class CmsAdvertisingAct {
	...
	public String list(Integer queryAdspaceId, Boolean queryEnabled, Integer pageNo, HttpServletRequest request, ModelMap model) {
		...
		Pagination pagination = manager.getPage(site.getId(), queryAdspaceId, queryEnabled, cpn(pageNo), CookieUtils.getPageSize(request));
	...
	public String update(Integer queryAdspaceId, Boolean queryEnabled, CmsAdvertising bean, Integer adspaceId, Integer pageNo,
	...
	public String uploadFlash(@RequestParam(value = "flashFile", required = false) MultipartFile file, String flashNum, HttpServletRequest request,
			ModelMap model) {
