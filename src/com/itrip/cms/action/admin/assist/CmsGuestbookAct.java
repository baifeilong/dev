...
import com.itrip.cms.entity.assist.CmsGuestbookCtg;
import com.itrip.cms.entity.assist.CmsGuestbookExt;
import com.itrip.cms.entity.main.CmsSite;
import com.itrip.cms.manager.assist.CmsGuestbookCtgMng;
import com.itrip.cms.manager.assist.CmsGuestbookMng;
...
public class CmsGuestbookAct {
	...
	public String list(Integer queryCtgId, Boolean queryRecommend, Boolean queryChecked, Integer pageNo, HttpServletRequest request, ModelMap model) {
		...
		Pagination pagination = manager.getPage(site.getId(), queryCtgId, null, queryRecommend, queryChecked, true, false, cpn(pageNo), CookieUtils
				.getPageSize(request));
	...
	public String add(HttpServletRequest request, ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
		List<CmsGuestbookCtg> ctgList = cmsGuestbookCtgMng.getList(site.getId());
	...
	public String update(Integer queryCtgId, Boolean queryRecommend, Boolean queryChecked, String oldreply, CmsGuestbook bean, CmsGuestbookExt ext,
			Integer ctgId, Integer pageNo, HttpServletRequest request, ModelMap model) {
		...
		return list(queryCtgId, queryRecommend, queryChecked, pageNo, request, model);
	}

	@RequestMapping("/guestbook/o_delete.do")
	public String delete(Integer queryCtgId, Boolean queryRecommend, Boolean queryChecked, Integer[] ids, Integer pageNo, HttpServletRequest request,
			ModelMap model) {
