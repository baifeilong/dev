...
import com.itrip.cms.manager.assist.CmsTaskMng;
...
import com.itrip.core.manager.FtpMng;
...
public class CmsTaskAct {
	...
	public String update(CmsTask bean, Integer pageNo, HttpServletRequest request, ModelMap model) throws SchedulerException, ParseException,
