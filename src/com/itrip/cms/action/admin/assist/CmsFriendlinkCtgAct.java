...
public class CmsFriendlinkCtgAct {
	...
	public String save(CmsFriendlinkCtg bean, HttpServletRequest request, ModelMap model) {
		...
		cmsLogMng.operating(request, "cmsFriendlinkCtg.log.save", "id=" + bean.getId() + ";name=" + bean.getName());
	...
	public String delete(Integer[] ids, HttpServletRequest request, ModelMap model) {
		...
		for (CmsFriendlinkCtg bean : beans) {
			...
			cmsLogMng.operating(request, "cmsFriendlinkCtg.log.delete", "id=" + bean.getId() + ";name=" + bean.getName());
		}
		return "redirect:v_list.do";
	}
