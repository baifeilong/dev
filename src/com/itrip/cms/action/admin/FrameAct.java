...
public class FrameAct {
    ...
    @RequestMapping("/frame/legislation_main.do")
    public String legislationMain(ModelMap model) {
        return "frame/legislation_main";
    }

    @RequestMapping("/frame/legislation_left.do")
    public String legislationLeft() {
        return "frame/legislation_left";
    }

    @RequestMapping("/frame/legislation_right.do")
    public String legislationRight() {
        return "frame/legislation_right";
    }
}
