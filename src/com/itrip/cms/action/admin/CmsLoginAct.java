...
import static com.itrip.core.action.front.LoginAct.MESSAGE;
import static com.itrip.core.action.front.LoginAct.PROCESS_URL;
import static com.itrip.core.action.front.LoginAct.RETURN_URL;
...
import com.itrip.common.security.BadCredentialsException;
import com.itrip.common.security.DisabledException;
import com.itrip.common.security.UsernameNotFoundException;
...
import com.itrip.core.entity.Config.ConfigLogin;
import com.itrip.core.manager.AuthenticationMng;
import com.itrip.core.manager.ConfigMng;
import com.itrip.core.manager.UnifiedUserMng;
...
public class CmsLoginAct {
    ...
    private final CmsUserMng cmsUserMng;
    private final UnifiedUserMng unifiedUserMng;
    private final ConfigMng configMng;
    private final AuthenticationMng authMng;
    private final SessionProvider session;
    private final ImageCaptchaService imageCaptchaService;
    private final CmsLogMng cmsLogMng;

    @Autowired
    public CmsLoginAct(CmsLogMng cmsLogMng, CmsUserMng cmsUserMng, ConfigMng configMng, AuthenticationMng authMng, SessionProvider session, ImageCaptchaService imageCaptchaService, UnifiedUserMng unifiedUserMng) {
    ...
    public String submit(String username, String password, String captcha, String message, HttpServletRequest request, HttpServletResponse response,
                         ModelMap model) {
        ...
        if (!errors.hasErrors()) {
            try {
                ...
                cmsLogMng.loginFailure(request, "login.log.loginFailure", "username=" + username);
