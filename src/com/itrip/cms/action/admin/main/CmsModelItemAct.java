...
public class CmsModelItemAct {
	...
	public String priority(Integer[] wids, Integer[] priority, String[] label, Boolean[] single, Boolean[] display, Integer modelId,
	...
	public String saveList(Integer modelId, Boolean isChannel, String[] fields, String[] labels, Integer[] dataTypes, Integer[] prioritys,
			Boolean[] singles, Boolean[] displays, HttpServletRequest request, ModelMap model) {
		CmsModel m = cmsModelMng.findById(modelId);
		List<CmsModelItem> itemList = getItems(m, isChannel, fields, labels, dataTypes, prioritys, singles, displays);
	...
	private List<CmsModelItem> getItems(CmsModel model, boolean isChannel, String[] fields, String[] labels, Integer[] dataTypes,
