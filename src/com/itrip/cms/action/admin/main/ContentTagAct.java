...
public class ContentTagAct {
	...
	public String list(Integer pageNo, HttpServletRequest request, ModelMap model) {
		...
		Pagination pagination = manager.getPage(queryName, cpn(pageNo), CookieUtils.getPageSize(request));
	...
	public String save(ContentTag bean, HttpServletRequest request, ModelMap model) {
		...
		cmsLogMng.operating(request, "contentTag.log.save", "id=" + bean.getId() + ";name=" + bean.getName());
	...
	public String update(ContentTag bean, Integer pageNo, HttpServletRequest request, ModelMap model) {
		...
		cmsLogMng.operating(request, "contentTag.log.update", "id=" + bean.getId() + ";name=" + bean.getName());
	...
	public String delete(Integer[] ids, Integer pageNo, HttpServletRequest request, ModelMap model) {
		...
		for (ContentTag bean : beans) {
			...
			cmsLogMng.operating(request, "contentTag.log.delete", "id=" + bean.getId() + ";name=" + bean.getName());
		}
		return list(pageNo, request, model);
	}
