...
import com.itrip.core.entity.Config.ConfigEmailSender;
import com.itrip.core.entity.Config.ConfigLogin;
import com.itrip.core.entity.Config.ConfigMessageTemplate;
...
public class CmsConfigAct {
	...
	public String memberUpdate(MemberConfig bean, ConfigLogin configLogin, ConfigEmailSender emailSender, ConfigMessageTemplate msgTpl,
	...
	public String loginUpdate(ConfigLogin configLogin, ConfigEmailSender emailSender, ConfigMessageTemplate msgTpl, HttpServletRequest request,
			ModelMap model) {
		// 留空则默认原有密码
