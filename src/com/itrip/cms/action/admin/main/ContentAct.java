...
import static com.itrip.common.page.SimplePage.cpn;
...
import com.itrip.cms.entity.main.CmsModelItem;
import com.itrip.cms.entity.main.CmsSite;
import com.itrip.cms.entity.main.CmsTopic;
...
import com.itrip.cms.entity.main.ContentType;
import com.itrip.cms.entity.main.Content.ContentStatus;
import com.itrip.cms.manager.assist.CmsFileMng;
import com.itrip.cms.manager.main.ChannelMng;
import com.itrip.cms.manager.main.CmsGroupMng;
import com.itrip.cms.manager.main.CmsLogMng;
import com.itrip.cms.manager.main.CmsModelItemMng;
import com.itrip.cms.manager.main.CmsModelMng;
import com.itrip.cms.manager.main.CmsTopicMng;
import com.itrip.cms.manager.main.CmsUserMng;
import com.itrip.cms.manager.main.ContentMng;
import com.itrip.cms.manager.main.ContentTypeMng;
...
import com.itrip.common.upload.FileRepository;
import com.itrip.common.util.StrUtils;
import com.itrip.common.web.CookieUtils;
import com.itrip.common.web.RequestUtils;
import com.itrip.common.web.ResponseUtils;
import com.itrip.common.web.springmvc.MessageResolver;
import com.itrip.core.entity.Ftp;
import com.itrip.core.manager.DbFileMng;
import com.itrip.core.tpl.TplManager;
import com.itrip.core.web.CoreUtils;
...
public class ContentAct {
	...
	public String list(String queryStatus, Integer queryTypeId, boolean needRegenerate, boolean queryTopLevel, boolean queryRecommend,
			Integer queryOrderBy, Integer cid, Integer pageNo, HttpServletRequest request, ModelMap model) {
		String queryId = RequestUtils.getQueryParam(request, "queryId");// 内容ID
		String queryTitle = RequestUtils.getQueryParam(request, "queryTitle");// 标题
		...
		Pagination p = manager.getPageByRight(StringUtils.isNotBlank(queryId) ? Integer.valueOf(queryId) : null, queryTitle, queryTypeId,
				queryInputUserId, queryTopLevel, queryRecommend, status, user.getCheckStep(siteId), siteId, cid, userId, needRegenerate,
		...
		addAttibuteForQuery(model, queryId, queryTitle, queryInputUsername, queryStatus, queryTypeId, needRegenerate, queryTopLevel, queryRecommend,
				queryOrderBy, pageNo);
	...
	public String view(String queryStatus, Integer queryTypeId, boolean needRegenerate, boolean queryTopLevel, boolean queryRecommend,
		...
		String queryId = RequestUtils.getQueryParam(request, "queryId");
	...
	public String edit(String queryStatus, Integer queryTypeId, boolean needRegenerate, boolean queryTopLevel, boolean queryRecommend,
			Integer queryOrderBy, Integer pageNo, Integer cid, Integer id, HttpServletRequest request, ModelMap model) {
		...
		/*
		 * // 模型 CmsModel m = channel.getModel();
		 */
		// 模型项列表
		List<CmsModelItem> itemList = cmsModelItemMng.getList(m.getId(), false, false);
		// 栏目列表
	...
	public String save(Content bean, ContentExt ext, ContentTxt txt, Integer[] channelIds, Integer[] topicIds, Integer[] viewGroupIds,
			String[] attachmentPaths, String[] attachmentNames, String[] attachmentFilenames, String[] picPaths, String[] picDescs,
			Integer channelId, Integer typeId, String tagStr, Boolean draft, Integer cid, Integer modelId, HttpServletRequest request, ModelMap model) {
		...
		bean = manager.save(bean, ext, txt, channelIds, topicIds, viewGroupIds, tagArr, attachmentPaths, attachmentNames, attachmentFilenames,
				picPaths, picDescs, channelId, typeId, draft, user, false);
		// 处理附件
		fileMng
				.updateFileByPaths(attachmentPaths, picPaths, ext.getMediaPath(), ext.getTitleImg(), ext.getTypeImg(), ext.getContentImg(), true,
						bean);
	...
	public String update(String queryStatus, Integer queryTypeId, boolean needRegenerate, Boolean queryTopLevel, Boolean queryRecommend,
			Integer queryOrderBy, Content bean, ContentExt ext, ContentTxt txt, Integer[] channelIds, Integer[] topicIds, Integer[] viewGroupIds,
			String[] attachmentPaths, String[] attachmentNames, String[] attachmentFilenames, String[] picPaths, String[] picDescs,
			Integer channelId, Integer typeId, String tagStr, Boolean draft, Integer cid, String[] oldattachmentPaths, String[] oldpicPaths,
			String oldTitleImg, String oldContentImg, String oldTypeImg, Integer pageNo, HttpServletRequest request, ModelMap model) {
		...
		bean = manager.update(bean, ext, txt, tagArr, channelIds, topicIds, viewGroupIds, attachmentPaths, attachmentNames, attachmentFilenames,
				picPaths, picDescs, attr, channelId, typeId, draft, user, false);
		// 处理之前的附件有效性
		...
		return list(queryStatus, queryTypeId, needRegenerate, queryTopLevel, queryRecommend, queryOrderBy, cid, pageNo, request, model);
	}

	@RequestMapping("/content/o_delete.do")
	public String delete(String queryStatus, Integer queryTypeId, boolean needRegenerate, Boolean queryTopLevel, Boolean queryRecommend,
			Integer queryOrderBy, Integer[] ids, Integer cid, Integer pageNo, HttpServletRequest request, ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
	...
	public String check(String queryStatus, Integer queryTypeId, boolean needRegenerate, Boolean queryTopLevel, Boolean queryRecommend,
			Integer queryOrderBy, Integer[] ids, Integer cid, Integer pageNo, HttpServletRequest request, ModelMap model) {
	...
	public String contentStatic(String queryStatus, Integer queryTypeId, boolean needRegenerate, Boolean queryTopLevel, Boolean queryRecommend,
			Integer queryOrderBy, Integer[] ids, Integer cid, Integer pageNo, HttpServletRequest request, ModelMap model) {
	...
	public String reject(String queryStatus, Integer queryTypeId, boolean needRegenerate, Boolean queryTopLevel, Boolean queryRecommend,
			Integer queryOrderBy, Integer[] ids, Integer cid, Byte rejectStep, String rejectOpinion, Integer pageNo, HttpServletRequest request,
			ModelMap model) {
	...
	public String uploadAttachment(@RequestParam(value = "attachmentFile", required = false) MultipartFile file, String attachmentNum,
	...
	public String uploadMedia(@RequestParam(value = "mediaFile", required = false) MultipartFile file, String filename, HttpServletRequest request,
			ModelMap model) {
		WebErrors errors = validateUpload(file, request);
		if (errors.hasErrors()) {
			model.addAttribute("error", errors.getErrors().get(0));
	...
	public String cycleList(Integer queryTypeId, boolean queryTopLevel, boolean queryRecommend, Integer queryOrderBy, Integer cid, Integer pageNo,
			HttpServletRequest request, ModelMap model) {
		list(ContentStatus.recycle.toString(), queryTypeId, false, queryTopLevel, queryRecommend, queryOrderBy, cid, pageNo, request, model);
		return "content/cycle_list";
	}

	@RequestMapping("/content_cycle/o_recycle.do")
	public String cycleRecycle(String queryStatus, Integer queryTypeId, boolean queryTopLevel, boolean queryRecommend, Integer queryOrderBy,
			Integer[] ids, Integer cid, Integer pageNo, HttpServletRequest request, ModelMap model) {
		WebErrors errors = validateDelete(ids, request);
		if (errors.hasErrors()) {
			return errors.showErrorPage(model);
		}
	...
	public String cycleDelete(String queryStatus, Integer queryTypeId, boolean queryTopLevel, boolean queryRecommend, Integer queryOrderBy,
			Integer[] ids, Integer cid, Integer pageNo, HttpServletRequest request, ModelMap model) {
		WebErrors errors = validateDelete(ids, request);
		if (errors.hasErrors()) {
			return errors.showErrorPage(model);
	...
	private void addAttibuteForQuery(ModelMap model, String queryId, String queryTitle, String queryInputUsername, String queryStatus,
			Integer queryTypeId, boolean needRegenerate, boolean queryTopLevel, boolean queryRecommend, Integer queryOrderBy, Integer pageNo) {
		...
		model.addAttribute("needRegenerate", needRegenerate);
