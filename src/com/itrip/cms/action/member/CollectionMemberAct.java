...
public class CollectionMemberAct {
	...
	public String collection_list(String queryTitle, Integer queryChannelId, Integer pageNo, HttpServletRequest request,
		...
		return FrontUtils.getTplPath(request, site, TPLDIR_MEMBER, COLLECTION_LIST);
	}
