...
import static com.itrip.cms.Constants.TPLDIR_GUESTBOOK;
...
public class GuestbookMemberAct {
	...
	public String myguestbook(Integer pageNo, Integer ctgId, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		Pagination pagination = guestbookMng.getPage(site.getId(), ctgId, user.getId(), null, null, true, false, cpn(pageNo), CookieUtils
				.getPageSize(request));
		model.addAttribute("pagination", pagination);
		return FrontUtils.getTplPath(request, site, TPLDIR_GUESTBOOK, GUESTBOOK_LIST);
	}
	...
	public String guestbook_detail(Integer id, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		return FrontUtils.getTplPath(request, site, TPLDIR_GUESTBOOK, GUESTBOOK_DETAIL);
	}
	...
	public String guestbook_replay(Integer id, String nextUrl, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		model.addAttribute("guestbook", guestbook);
		return FrontUtils.getTplPath(request, site, TPLDIR_GUESTBOOK, GUESTBOOK_REPLAY);
	}
