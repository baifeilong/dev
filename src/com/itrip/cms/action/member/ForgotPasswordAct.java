...
import com.itrip.common.email.EmailSender;
import com.itrip.common.email.MessageTemplate;
import com.itrip.common.web.session.SessionProvider;
import com.itrip.core.entity.UnifiedUser;
...
public class ForgotPasswordAct {
	...
	public String forgotPasswordInput(HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		return FrontUtils.getTplPath(request, site, TPLDIR_MEMBER, FORGOT_PASSWORD_INPUT);
	}
	...
	public String forgotPasswordSubmit(String username, String email, String captcha, HttpServletRequest request, HttpServletResponse response,
			ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
		...
		return FrontUtils.getTplPath(request, site, TPLDIR_MEMBER, FORGOT_PASSWORD_RESULT);
	}
	...
	public String passwordReset(Integer uid, String key, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		FrontUtils.frontData(request, model, site);
		return FrontUtils.getTplPath(request, site, TPLDIR_MEMBER, PASSWORD_RESET);
	}

	private WebErrors validateForgotPasswordSubmit(String username, String email, String captcha, HttpServletRequest request,
