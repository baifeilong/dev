...
import static com.itrip.cms.Constants.TPLDIR_MESSAGE;
...
public class MessageAct {
	...
	public String message_mng(Integer box, String msg, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		return FrontUtils.getTplPath(request, site, TPLDIR_MESSAGE, MESSAGE_MNG);
	}
	...
	public String message_inbox(Integer pageNo, String title, Date sendBeginTime, Date sendEndTime, Boolean status, Integer box,
		...
		model.addAttribute("box", box);
		return FrontUtils.getTplPath(request, site, TPLDIR_MESSAGE, returnPage);
	}
	...
	public String message_add(HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		return FrontUtils.getTplPath(request, site, TPLDIR_MESSAGE, MESSAGE_ADD);
	}
	...
	public String message_reply(Integer id, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		return FrontUtils.getTplPath(request, site, TPLDIR_MESSAGE, MESSAGE_REPLY);
	}

	// 直接发送
	@RequestMapping(value = "/member/message_send.jspx")
	public String message_send(CmsMessage message, String username, String captcha, String nextUrl, HttpServletRequest request,
	...
	public String message_save(CmsMessage message, String username, String captcha, String nextUrl, HttpServletRequest request,
			HttpServletResponse response, ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
		CmsUser user = CmsUtils.getUser(request);
		FrontUtils.frontData(request, model, site);
	...
	public String message_edit(Integer id, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		model.addAttribute("message", message);
		return FrontUtils.getTplPath(request, site, TPLDIR_MESSAGE, MESSAGE_EDIT);
	}

	@RequestMapping(value = "/member/message_update.jspx")
	public String message_update(CmsMessage message, String nextUrl, String captcha, HttpServletRequest request, HttpServletResponse response,
			ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
		CmsUser user = CmsUtils.getUser(request);
		FrontUtils.frontData(request, model, site);
	...
	public String message_read(Integer id, Integer box, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		model.addAttribute("box", box);
		return FrontUtils.getTplPath(request, site, TPLDIR_MESSAGE, MESSAGE_READ);
	}
