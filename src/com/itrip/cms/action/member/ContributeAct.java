...
import static com.itrip.cms.Constants.TPLDIR_MEMBER;
...
public class ContributeAct {
	...
	public String list(String queryTitle, Integer queryChannelId, Integer pageNo, HttpServletRequest request, ModelMap model) {
		...
		return FrontUtils.getTplPath(request, site, TPLDIR_MEMBER, CONTRIBUTE_LIST);
	}
	...
	public String add(HttpServletRequest request, ModelMap model) {
		...
		return FrontUtils.getTplPath(request, site, TPLDIR_MEMBER, CONTRIBUTE_ADD);
	}
	...
	public String save(String title, String author, String description, String txt, String tagStr, Integer channelId, Integer modelId,
			String captcha, String nextUrl, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
		CmsUser user = CmsUtils.getUser(request);
		FrontUtils.frontData(request, model, site);
		MemberConfig mcfg = site.getConfig().getMemberConfig();
	...
	public String edit(Integer id, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		model.addAttribute("channelList", channelList);
		return FrontUtils.getTplPath(request, site, TPLDIR_MEMBER, CONTRIBUTE_EDIT);
	}
	...
	private WebErrors validateSave(String title, String author, String description, String txt, String tagStr, Integer channelId, CmsSite site,
			CmsUser user, String captcha, HttpServletRequest request, HttpServletResponse response) {
