...
import com.itrip.cms.action.directive.abs.AbstractCmsGuestbookDirective;
...
public class CmsGuestbookListDirective extends AbstractCmsGuestbookDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		List<CmsGuestbook> list = cmsGuestbookMng.getList(getSiteId(params), getCtgId(params), getRecommend(params), getChecked(params),
