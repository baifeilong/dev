...
public class Constants {
	...
	/** 会员中心模板 */
	public static final String TPLDIR_MEMBER = "  ";
	/** 搜索模板 */
	...
	/** 上传路径 白飞龙 2015-12-18 */
	public static final String UPLOAD_PATH = "/var/www/data/work/itrip_guide/upload_file";
	/** 静态化文件存储路径 白飞龙 2015-12-18 */
	public static final String STATIC_PATH = "/var/www/data/work/itrip_guide/static_page/pc";
	/** 移动端静态化文件存储路径 白飞龙 2015-12-18 */
	public static final String STATIC_MOBILE_PATH = "/var/www/data/work/itrip_guide/static_page/mobile";
	/** 全文检索索引路径 */
	public static final String LUCENE_PATH = "/var/www/data/work/itrip_guide/luence";
	/** 七牛图片访问绝对路径 */
	public static final String ABSOLUTE_PATH = "http://picguide.itrip.com";
	/** 文件虚拟路径 */
