...
import com.itrip.cms.dao.assist.CmsReceiverMessageDao;
...
public class CmsReceiverMessageDaoImpl extends HibernateBaseDao<CmsReceiverMessage, Integer> implements CmsReceiverMessageDao {
	...
	public Pagination getPage(Integer siteId, Integer sendUserId, Integer receiverUserId, String title, Date sendBeginTime, Date sendEndTime,
		...
		if (sendUserId != null && receiverUserId != null) {
			finder
					...
					.setParam("sendUserId", sendUserId).setParam("receiverUserId", receiverUserId).setParam("box", box);
		} else {
			if (sendUserId != null) {
	...
	public List<CmsReceiverMessage> getList(Integer siteId, Integer sendUserId, Integer receiverUserId, String title, Date sendBeginTime,
