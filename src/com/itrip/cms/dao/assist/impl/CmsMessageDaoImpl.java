...
import com.itrip.cms.dao.assist.CmsMessageDao;
...
public class CmsMessageDaoImpl extends HibernateBaseDao<CmsMessage, Integer> implements CmsMessageDao {
	...
	public Pagination getPage(Integer siteId, Integer sendUserId, Integer receiverUserId, String title, Date sendBeginTime, Date sendEndTime,
		...
		if (sendUserId != null && receiverUserId != null) {
			finder.append(" and (msg.msgSendUser.id=:sendUserId or msg.msgReceiverUser.id=:receiverUserId)").setParam("sendUserId", sendUserId)
