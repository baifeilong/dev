...
import static com.itrip.cms.entity.main.Content.ContentStatus.all;
import static com.itrip.cms.entity.main.Content.ContentStatus.checked;
import static com.itrip.cms.entity.main.Content.ContentStatus.draft;
import static com.itrip.cms.entity.main.Content.ContentStatus.passed;
import static com.itrip.cms.entity.main.Content.ContentStatus.prepared;
import static com.itrip.cms.entity.main.Content.ContentStatus.recycle;
import static com.itrip.cms.entity.main.Content.ContentStatus.rejected;
...
public class ContentDaoImpl extends HibernateBaseDao<Content, Integer> implements ContentDao {
	...
	public Pagination getPage(Integer id, String title, Integer typeId, Integer inputUserId, boolean topLevel, boolean recommend,
			ContentStatus status, Byte checkStep, Integer siteId, Integer channelId, boolean needRegenerate, int orderBy, int pageNo, int pageSize) {
		...
		if (needRegenerate) { // 加入待生成静态页查询条件，筛选所有未生成静态页的内容
			f.append(" and bean.contentExt.needRegenerate=:needRegenerate");
			f.setParam("needRegenerate", needRegenerate);
		}
		if (prepared == status) {
		...
		appendQuery(f, id, title, typeId, inputUserId, status, topLevel, recommend);
		if (prepared == status) {
	...
	public Pagination getPageBySelf(Integer id, String title, Integer typeId, Integer inputUserId, boolean topLevel, boolean recommend,
	...
	public Pagination getPageByRight(Integer id, String title, Integer typeId, Integer inputUserId, boolean topLevel, boolean recommend,
			ContentStatus status, Byte checkStep, Integer siteId, Integer channelId, Integer userId, boolean selfData, boolean needRegenerate,
	...
	public int resetNeedStatic() {
		Finder f = Finder.create("update ContentExt o set o.needRegenerate = 1 where o.needRegenerate = 0");
		Query q = f.createQuery(getSession());
		return q.executeUpdate();
	}

	private void appendQuery(Finder f, Integer id, String title, Integer typeId, Integer inputUserId, ContentStatus status, boolean topLevel,
			boolean recommend) {
		if (id != null) {
